...
client.publish("Lock/isfcr/cabinb",lock1string);
client.publish("Unlock/isfcr/cabinb",unlock1string);
client.publish("isfcr/cabinb/in",intime1);
client.publish("isfcr/cabinb/out",outtime1);
}
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("isfcr")) {
      Serial.println("connected");  
      digitalWrite(door3,HIGH);
      client.subscribe("isfcr/cabinb");
